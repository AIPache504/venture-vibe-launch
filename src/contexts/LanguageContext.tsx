...
const translations: Translations = {
  en: {
    title: "MAY VENTURES",
    subtitle: "We invest in european AI pioneers & technology leaders from our home region",
  ...
  de: {
    title: "MAY VENTURES",
    subtitle: "Wir investieren in europäische KI-Pioniere und Technologieführer aus unserer Heimat",
